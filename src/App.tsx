      ...
      <main className="max-w-7xl mx-auto w-full p-4 sm:p-8 grid grid-cols-12 gap-6 sm:gap-8 flex-1 items-start">
              ...
              <AnimatePresence initial={false}>
                ...
                {filteredInvoices.length === 0 && searchQuery && (
                  <div className="p-8 text-center bg-slate-50 border border-dashed border-slate-200 rounded-3xl">
                    ...
                    <p className="text-xs font-bold text-slate-400">No matches found in your queue.</p>
                  </div>
                )}
              </AnimatePresence>
            </div>
        ...
        <div className="col-span-12 lg:col-span-8 bg-white rounded-3xl shadow-sm border border-slate-200 flex flex-col min-h-[700px] overflow-hidden">
          {selectedInvoiceId === 'bulk' ? (
            ...
            <div className="h-full flex flex-col items-center justify-center text-center p-20 relative overflow-hidden">
               <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_120%,rgba(79,70,229,0.05),transparent)] pointer-events-none" />
               <motion.div 
                 initial={{ opacity: 0, scale: 0.8, rotate: -20 }}
                 animate={{ opacity: 1, scale: 1, rotate: 12 }}
                 transition={{ duration: 0.8, type: 'spring' }}
                 className="w-32 h-32 bg-white rounded-[2.5rem] shadow-2xl flex items-center justify-center mb-10 relative z-10"
               >
                  <FileText className="w-16 h-16 text-brand" />
                  <div className="absolute -top-2 -right-2 w-8 h-8 bg-brand rounded-full flex items-center justify-center border-4 border-white shadow-lg">
               ...
               >
                 <h3 className="text-4xl font-black tracking-tighter text-slate-900 max-w-sm mx-auto leading-[0.9]">
                   Ready to <span className="text-brand">Extract</span> Data?
                 </h3>
                 <p className="text-sm font-medium text-slate-400 mt-6 max-w-xs mx-auto leading-relaxed">
                 ...
                 <div className="mt-10 flex flex-wrap items-center justify-center gap-4 sm:gap-8">
                    <Link 
                      to="/docs"
                      className="w-full sm:w-auto px-6 py-3 bg-white border border-slate-100 rounded-2xl text-[10px] font-black uppercase tracking-widest text-slate-400 hover:text-brand hover:border-brand/20 transition-all flex items-center justify-center gap-2 shadow-sm"
                    >
                      View Documentation
                    </Link>
                    <div className="hidden sm:block w-px h-8 bg-slate-100" />
                    <div className="flex flex-col items-center gap-1 min-w-[80px]">
                      <span className="text-xl font-black text-slate-800">1.5B+</span>
